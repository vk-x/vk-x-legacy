...
function vkStyles(){
   ...
   if (hideBigLike) main_css+="#pv_hh{display:none !important;}";
	...
	main_css+='\
      ...
      .group_name .vk_adm_group, .profile_info .vk_adm_group{padding:0 !important;}\
   ...
   .vk_pr_tt{width:300px}\
	"+(RemoveAd=='y'?".post[data-ads], .ad_box,.ad_help_link, .ad_help_link_new, .ad_box_new, #ad_help_link_new, #left_ads, .ads_ads_news_wrap {display: none !important;}\
   ...
   ';
	...
	main_css+='\
      ...
      .im_fwd_log_row .audio .title_wrap, .im_fwd_log_row .post_media .audio .title_wrap { width: 210px;}\
      .audios_module .audio .title_wrap { width: 310px !important; }\
...
function vkMenu(){//vkExLeftMenu
  ...
  var vkmenu_css1='\
         ...
         .vkico_fave,.vkico_custom_link{background-position:0 -118px;}\
         ...
         .vkico_support{background-position: 0px -320px}\
         \
